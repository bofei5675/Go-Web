...
func (user *User) Validate() error  {
	/*
	Fill the validation logic inside this function.
	 */
...
func (user *User) Create() (int64,error) {
	/*
	Call create to insert an user into db
	 */
...
func (user *User) UserToJson() string {
	...
	it can call marshal methods recursively, very powerful!
	 */
...
func (user *User) JsonToUser(jsonBlob string) error {
	/*
	Load a json string into bytes
	Then convert these bytes into struct by unmarshal func
	 */
